    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-content">
                ...
                <section class="row">
                    <div class="col-12 col-md-9 order-md-0 order-1">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        WHERE user_id != '$user_id'
                                         ";
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                <tr>
                                                    <th colspan="6" class="text-center">Tidak ada kelas dengan nama <i><?= $_GET['cari'] ?></i></th>
                                                </tr>
                                            <?php
                                            }
                                            ?>
                    ...
                    <div class="col-12 col-md-3 order-md-1 order-0">
                        <div class="card">
                            <div class="card-body" style="height: 200px;">
                                <p>Masuk kelas</p>
                                <form action="<?= $url . "/siswa/konfirmasi-kelas.php" ?>" method="post" class="d-flex gap-2">
